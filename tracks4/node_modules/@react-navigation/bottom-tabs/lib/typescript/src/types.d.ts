...
import type { Animated, TouchableWithoutFeedbackProps, StyleProp, TextStyle, ViewStyle, GestureResponderEvent } from 'react-native';
import type { NavigationHelpers, NavigationProp, ParamListBase, Descriptor, TabNavigationState, TabActionHelpers, RouteProp } from '@react-navigation/native';
...
export declare type BottomTabScreenProps<ParamList extends ParamListBase, RouteName extends keyof ParamList = string> = {
...
export declare type BottomTabNavigationConfig<T = BottomTabBarOptions> = {
    /**
...
export declare type BottomTabBarProps<T = BottomTabBarOptions> = T & {
